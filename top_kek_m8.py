...
if uploaded_file is not None:
    ...
    ecr_list = ['cape_exterior_condition_rating','cape_response_status','cape_primary_structure_latitude', 'cape_primary_structure_longitude','Address', 'City', 'State', 'Zip','cape_exterior_condition_rating_image_url','cape_roof_condition_rating_date']
    ...
    pool_list = ['cape_pool_condition_rating','cape_pool_presence','cape_pool_structure_type','cape_response_status','cape_primary_structure_latitude', 'cape_primary_structure_longitude','Address', 'City', 'State', 'Zip', 'cape_pool_condition_rating_image_url','cape_roof_condition_rating_date']
    acc_struct_list = ['cape_accessory_structure_count','cape_accessory_structure_roof_condition_rating','cape_response_status','cape_primary_structure_latitude', 'cape_primary_structure_longitude','Address', 'City', 'State', 'Zip','cape_roof_condition_rating_date']
    roof_list= ['cape_roof_condition_rating', 'cape_roof_condition_rating_date','cape_response_status','cape_primary_structure_latitude', 'cape_primary_structure_longitude','Address', 'City', 'State', 'Zip', 'cape_roof_condition_rating_image_url']
    tree_overhang_list = ['cape_tree_overhang','cape_response_status','cape_primary_structure_latitude', 'cape_primary_structure_longitude','Address', 'City', 'State', 'Zip', 'cape_tree_overhang_image_url','cape_roof_condition_rating_date']
    yard_list = ['cape_yard_debris_coverage_pct', 'cape_yard_debris_coverage_sqft', 'cape_response_status','cape_primary_structure_latitude', 'cape_primary_structure_longitude','Address', 'City', 'State', 'Zip','cape_yard_debris_coverage_pct_image_url','cape_roof_condition_rating_date']
    ...
    count = 0
    for n in n_images:
        st.image(n,caption=f"Address: {chosen_df.iloc[count]['Address']}, {chosen_df.iloc[count]['City']}, {chosen_df.iloc[count]['State']} {chosen_df.iloc[count]['Zip']}. Imagery Date: {chosen_df.iloc[count]['cape_roof_condition_rating_date']}", width=size)
        count += 1
        st.download_button(
