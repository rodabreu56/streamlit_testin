...
if uploaded_file is not None:
    ...
    roof_list= ['cape_roof_condition_rating', 'cape_roof_condition_rating_date','cape_response_status','cape_primary_structure_latitude', 'cape_primary_structure_longitude','Address', 'cape_roof_condition_rating_image_url']
    tree_overhang_list = ['cape_tree_overhang','cape_response_status','cape_primary_structure_latitude', 'cape_primary_structure_longitude','Address','cape_tree_overhang_image_url','cape_roof_condition_rating_date']
