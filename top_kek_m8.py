...
if uploaded_file is not None:
    ...
    for i in range(n):
        ...
        st.image(filtered_df2[i],caption=f"Address: {chosen_df.iloc[i][addr_field]}, {city}, {state} {zipcode}. Imagery Date: {chosen_df.iloc[i]['cape_roof_condition_rating_date']}", width=size)
        #count += 1
        st.download_button(
